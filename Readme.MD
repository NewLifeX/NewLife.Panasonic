...
```csharp
// 创建串口驱动
var driver = new PanasonicRtuDriver();

// 配置串口参数
var param = new PanasonicRtuParameter
{
    PortName = "COM3",
    Baudrate = 9600,
    DataBits = 8,
...
| 驱动 | 协议 | 连接方式 | 注册名 | 
|------|------|----------|--------|
| `PanasonicDriver` | Modbus TCP | 以太网（网关模式） | `PanasonicPLC` |
| `PanasonicRtuDriver` | Modbus RTU | RS232/485 串口 | `PanasonicRTU` |
