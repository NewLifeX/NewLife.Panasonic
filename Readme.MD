...
松下PLC协议。基于 NewLife.IoT 标准框架，为 .NET 应用提供松下 PLC 设备的多种通信驱动（Modbus TCP / Modbus RTU / Mewtocol TCP）。
...
| [架构设计](Doc/架构设计.md) | 分层、组件、流程与设计决策 |
| [竞品分析报告](Doc/竞品分析报告.md) | 竞品对比、功能矩阵、差距分析与建议 |
